            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item">
                    <router-link to="/calculations" class="sidebar-link">
                        ...
                        <span class="badge badge-sidebar-primary">{{calculations_count}}</span>
                    </router-link>
                </li>
                <li class="sidebar-item">
                    <router-link to="/offers" class="sidebar-link">
                        ...
                        <span class="badge badge-sidebar-primary">{{offers_count}}</span>
                    </router-link>
                </li>
                <li class="sidebar-item">
                    <router-link to="/elements" class="sidebar-link">
                        ...
                        <span class="badge badge-sidebar-primary">{{elements_count}}</span>
                    </router-link>
                </li>
                <li class="sidebar-header">
