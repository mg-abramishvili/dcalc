...
<script>
    export default {
        ...
        created() {
            axios
                .get('/api/calculations_count')
                .then(response => (
                    this.calculations_count = response.data
                ));
            axios
                .get('/api/offers_count')
                .then(response => (
                    this.offers_count = response.data
                ));
            axios
                .get('/api/elements_count')
                .then(response => (
                    this.elements_count = response.data
                ));
        },
        components: {
        }
